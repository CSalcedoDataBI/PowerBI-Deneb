# Grouped Bar Chart with Cross-filtering

This template is reusable and consists of two categories and one measure. The Grouped Bar Chart is based on the official Vega-Lite example and has been adapted for Deneb in Power BI with enhanced interactivity, including cross-filtering capabilities. Author: Cristobal Salcedo Beltran

## El spec

- [`Files/Group_Bar_Chart_With_Cross_Filtering.json`](Files/Group_Bar_Chart_With_Cross_Filtering.json)
