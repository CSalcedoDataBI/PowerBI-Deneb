...
Based on an official Vega-Lite example and adapted for use in Deneb within Power BI. Note: Cross-filtering interactivity is limited when using 'aggregate'.

## El spec

- [`Files/Layered_Bar_Chart.json`](Files/Layered_Bar_Chart.json)

Creado con Deneb `1.7.1.0` sobre `vegaLite` `5.20.1`.
