...
Normalized (Percentage) Stacked Bar Chart: Based on an official Vega-Lite example and adapted for use in Deneb within Power BI. Note: Cross-filtering interactivity is limited when using 'aggregate'. Author: Cristobal Salcedo Beltran. Contact: contacto@csalcedodatabi.com

## El spec

- [`Files/Normalized_Percentage_Stacked_Bar_Chart.json`](Files/Normalized_Percentage_Stacked_Bar_Chart.json)

Creado con Deneb `1.7.0.0` sobre `vegaLite` `5.19.0`.
