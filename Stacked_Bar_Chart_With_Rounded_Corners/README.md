...
Based on an official Vega-Lite example and adapted for use in Deneb within Power BI, it should be noted that cross-filtering interactivity is limited when using 'aggregate'. Author: Cristobal Salcedo Beltran. Contact: contacto@csalcedodatabi.com.

## El spec

- [`Files/Template_Stacked_Bar_Chart_With_Rounded_Corners.json`](Files/Template_Stacked_Bar_Chart_With_Rounded_Corners.json)
